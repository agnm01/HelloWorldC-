...
namespace HelloWorldWeb.Tests
{
    public class WeatherControllerTests
    {
        ...
        public void TestCheckingConversion()
        {
            ...
            Assert.Equal(weatherController.ConvertKelvinToCelsius(297.88f), firstDay.Temperature);
